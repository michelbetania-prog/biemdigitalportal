...
for(const token of ['KanbanBoard','TaskDetail','TaskFilters','TaskList','TaskCalendar','AssignedClients','No tienes tareas asignadas por ahora.','No tienes clientes asignados todavía.'])if(!app.includes(token))throw new Error(`Team workspace missing: ${token}`)
