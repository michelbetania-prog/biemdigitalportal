...
for(const token of ['.portal-settings-page','--portal-background','data-card-style','data-portal-theme'])if(!styles.includes(token))throw new Error(`Dynamic theme styles missing: ${token}`)
